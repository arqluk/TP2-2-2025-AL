...
router.put("/animals/update/all/:identificador", animalsController.putAnimals)
// Actualización de una parte
router.patch("/animals/update/:identificador", animalsController.patchAnimals)
router.delete("/animals/delete/:identificador", animalsController.deleteAnimals)
